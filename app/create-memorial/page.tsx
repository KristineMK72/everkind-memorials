      ...
      <section className="mx-auto max-w-3xl space-y-6">
        <div className="rounded-2xl border border-neutral-200 bg-white p-8">
          ...
          <p className="mt-3 text-neutral-700">
            Your details are saved. Next we’ll connect this to publishing and (optionally)
            payment. For now, you can go back and edit anytime.
          </p>
    ...
    <section className="mx-auto max-w-3xl space-y-6">
      <div className="rounded-2xl border border-neutral-200 bg-white p-8">
        ...
        <p className="mt-3 text-xs text-neutral-500">
          Submissions are reviewed for care, clarity, and dignity. Most memorials are approved
          within 24–48 hours.
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-neutral-200 bg-white p-8 space-y-4">
        ...
        {Object.keys(errors).length > 0 ? (
          <p className="text-sm text-neutral-600">
            Tip: Fill in the required fields (name, city/state, short summary, and your contact)
            to continue.
          </p>
        ) : null}
      </div>
