...
type Memorial = {
  ...
  death?: string;
  cityState?: string;
  photoUrl?: string; // Optional memorial photo
  obituary: string;
  lifeMoments?: string[];
  family?: string[];
  service?: {
...
function getDemoMemorial(slug: string): Memorial {
  ...
  if (["wayne-kahler", "example", "demo", "uncle"].includes(slug)) {
    return {
      slug,
      ...
      // Uncomment & paste real direct image URL when ready:
      // photoUrl: "https://example.com/wayne-portrait.jpg",
  ...
  // Default fallback memorial (used until real data is connected)
  return {
    slug,
    ...
    <main>
      <div className="container">
        ...
        {memorial.photoUrl && (
          <>
            <div style={{ height: 18 }} />
            <div className="card" style={{ padding: 12, borderRadius: 22, overflow: "hidden" }}>
